...
<script>
import { delAds } from "@/api/homeimage";
...
export default {
  ...
  methods: {
    ...
    editAdsInfo(index, rows) {
      ...
      this.$router.push(
        this.$root.adminBasePath + "/homeimage/editAds/" + rowData._id
      );
    },
      ...
      this.$confirm(
        ...
        .then(result => {
          if (result.status === 200) {
            this.$store.dispatch("homeimage/getAdsList");
            this.$message({
